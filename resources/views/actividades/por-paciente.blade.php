...
@section('title', 'Actividades por Paciente')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Actividades de {{ $paciente->usuario->nombre }} {{ $paciente->usuario->apPaterno }}</h2>
                        <p class="text-gray-600">Historial de actividades clínicas del paciente</p>
                    </div>
                        ...
                        <div class="flex-shrink-0 h-16 w-16">
                            <div class="h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center">
                                <span class="text-xl font-medium text-blue-800">
                                    {{ substr($paciente->usuario->nombre, 0, 1) }}{{ substr($paciente->usuario->apPaterno, 0, 1) }}
                                </span>
                            </div>
                        </div>
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">{{ $paciente->usuario->correo }}</p>
                            @if($paciente->usuario->telefono)
                                <p class="text-sm text-gray-500">{{ $paciente->usuario->telefono }}</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <form method="GET" action="{{ route('medico.actividades.por-paciente', $paciente->id_paciente) }}" class="space-y-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        No se encontraron actividades para este paciente.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
