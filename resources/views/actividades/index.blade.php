        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Gestión de Actividades</h2>
                        <p class="text-gray-600">Administra las actividades clínicas asignadas a los pacientes</p>
                    </div>
                    <div class="flex space-x-3">
                        <a href="{{ route('medico.actividades.create') }}" 
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-2xl font-bold text-red-900">{{ $stats['vencidas'] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-2xl font-bold text-purple-900">{{ $stats['porcentaje_cumplimiento'] }}%</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <form method="GET" action="{{ route('medico.actividades.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                            ...
                            <div>
                                <label for="periodicidad" class="block text-sm font-medium text-gray-700 mb-1">Periodicidad</label>
                                <select name="periodicidad" 
                                        id="periodicidad"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                                    <option value="">Todas las periodicidades</option>
                                    @foreach($periodicidades as $periodicidad)
                                        <option value="{{ $periodicidad }}" {{ request('periodicidad') == $periodicidad ? 'selected' : '' }}>
                                            {{ $periodicidad }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                <label for="tipo_actividad" class="block text-sm font-medium text-gray-700 mb-1">Tipo de Actividad</label>
                                <input type="text" 
                                       name="tipo_actividad" 
                                       id="tipo_actividad"
                                       value="{{ request('tipo_actividad') }}"
                                       placeholder="Ej: Ejercicio, Dieta..."
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                            </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select name="sort_by" 
                                    ...
                                    <option value="fecha_asignacion" {{ request('sort_by') == 'fecha_asignacion' ? 'selected' : '' }}>Fecha de Asignación</option>
                                    <option value="fecha_limite" {{ request('sort_by') == 'fecha_limite' ? 'selected' : '' }}>Fecha Límite</option>
                                    <option value="nombre" {{ request('sort_by') == 'nombre' ? 'selected' : '' }}>Nombre</option>
                                    <option value="completada" {{ request('sort_by') == 'completada' ? 'selected' : '' }}>Estado</option>
                                </select>
                            ...
                            @forelse($actividades as $actividad)
                                <tr class="hover:bg-gray-50">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    <a href="{{ route('medico.actividades.por-paciente', $actividad->paciente->id_paciente) }}" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('medico.actividades.show', $actividad->id_actividad) }}" 
