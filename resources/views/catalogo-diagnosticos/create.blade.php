...
@section('title', 'Agregar Diagnóstico al Catálogo')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Agregar Diagnóstico al Catálogo</h2>
                        <p class="text-gray-600">Registra un nuevo diagnóstico médico en el catálogo</p>
                    </div>
                ...
                <!-- Formulario -->
                <form method="POST" action="{{ route(Auth::user()->isAdmin() ? 'admin.catalogo-diagnosticos.store' : 'medico.catalogo-diagnosticos.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion_clinica" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('descripcion_clinica') border-red-500 @enderror">{{ old('descripcion_clinica') }}</textarea>
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <ul class="list-disc list-inside space-y-1">
                                        <li>El diagnóstico será agregado al catálogo y estará disponible para todos los usuarios</li>
                                        <li>El código es opcional pero debe ser único si se proporciona</li>
                                        <li>La categoría médica ayuda a organizar los diagnósticos</li>
                                        <li>Este diagnóstico podrá ser seleccionado al crear nuevos diagnósticos de pacientes</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
