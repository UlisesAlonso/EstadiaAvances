                    ...
                    <ul class="space-y-2">
                        @auth
                            @if(auth()->user()->isAdmin())
                                ...
                                <li>
                                    <a href="{{ route('admin.foro.moderacion') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition {{ request()->routeIs('admin.foro.*') ? 'bg-blue-50 text-blue-700' : '' }}">
                                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ route('admin.reportes.index') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition {{ request()->routeIs('admin.reportes.*') ? 'bg-blue-50 text-blue-700' : '' }}">
                                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @else
                                ...
                                <li>
                                    <a href="{{ route('foro.index') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition {{ request()->routeIs('foro.*') || request()->routeIs('paciente.foro.*') ? 'bg-blue-50 text-blue-700' : '' }}">
                                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
