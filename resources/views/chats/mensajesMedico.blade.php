...
@section('title', 'Mensajes del Médico')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Comunícate con tus pacientes</p>
            </div>
            ...
            <!-- Selector para iniciar nuevo chat -->
            <div class="flex items-center space-x-2">
                <select id="select-paciente" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="">Iniciar chat con paciente...</option>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3 flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 truncate">
                                                {{ $otroUsuario->rol == 'paciente' ? 'Paciente' : 'Usuario' }}
                                            </p>
                                        </div>
                                    </div>
                                </button>
                ...
                <div class="flex-1 flex flex-col">
                    ...
                    <div id="chat-header" class="p-4 border-b border-gray-200 bg-white">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="h-10 w-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold mr-3" id="chat-avatar">
                                    ?
                                </div>
                                <div>
...
<script>
    ...
    document.getElementById('form-mensaje').addEventListener('submit', function(e) {
        ...
        if (!mensaje || !currentChatId) {
            console.error('Datos incompletos para enviar mensaje:', { mensaje, currentChatId });
            alert('Por favor selecciona un chat y escribe un mensaje');
            return;
        }
        ...
        socket.emit('send_message', {
            id_chat: parseInt(currentChatId),
    ...
    // Iniciar nuevo chat con un paciente
    function iniciarNuevoChat() {
        ...
        // Redirigir a la ruta de iniciar chat
        window.location.href = `/mensajes/iniciar-chat/${idPaciente}`;
    }
</script>
<script>
// Función simple para mostrar alerta por 3 segundos
