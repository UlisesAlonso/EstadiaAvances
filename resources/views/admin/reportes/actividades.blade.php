    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Reporte de Efectividad de Actividades</h2>
                    <p class="text-gray-600 mt-2">Análisis de efectividad de actividades asignadas a pacientes</p>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form method="POST" action="{{ route('admin.reportes.actividades.pdf') }}" id="formReporte">
                    @csrf
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        ...
                        <button type="submit" 
                                class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 inline-flex items-center">
                            <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-yellow-800">Información del Reporte</h3>
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>Este reporte genera un PDF profesional con:</p>
                        <ul class="list-disc list-inside mt-2 space-y-1">
                            <li>Tasas de completitud y cumplimiento de actividades</li>
                            <li>Estadísticas por nombre de actividad</li>
                            <li>Estadísticas por paciente</li>
                            <li>Análisis de efectividad detallado</li>
                        </ul>
                    </div>
                </div>
            </div>
