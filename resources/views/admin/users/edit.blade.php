                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="apPaterno" id="apPaterno" 
                               value="{{ old('apPaterno', $user->apPaterno) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="apMaterno" id="apMaterno" 
                               value="{{ old('apMaterno', $user->apMaterno) }}"
                    ...
                    <div>
                        ...
                        <select name="rol" id="rol" required
                            ...
                            <option value="medico" {{ old('rol', $user->rol) == 'medico' ? 'selected' : '' }}>
                                Médico
                            </option>
                            <option value="paciente" {{ old('rol', $user->rol) == 'paciente' ? 'selected' : '' }}>
                                Paciente
                            </option>
                        </select>
                        @error('rol')
                    ...
                    <div id="campos-medico" class="md:col-span-2 {{ $user->rol === 'medico' ? '' : 'hidden' }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="especialidad" id="especialidad" 
                                       value="{{ old('especialidad', $user->medico->especialidad ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="cedula_profesional" id="cedula_profesional" 
                                       value="{{ old('cedula_profesional', $user->medico->cedula_profesional ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_nacimiento_medico" id="fecha_nacimiento_medico" 
                                       value="{{ old('fecha_nacimiento_medico', $user->medico->fecha_nacimiento ?? '') }}"
                    ...
                    <div id="campos-paciente" class="md:col-span-2 {{ $user->rol === 'paciente' ? '' : 'hidden' }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" 
                                       value="{{ old('fecha_nacimiento', $user->paciente->fecha_nacimiento ?? '') }}"
