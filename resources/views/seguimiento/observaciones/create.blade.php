...
@section('title', 'Nueva Observación Médica')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Nueva Observación Médica</h2>
                        <p class="text-gray-600">Registra una nueva observación para el paciente</p>
                    </div>
                ...
                <div class="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p class="text-sm text-blue-700">{{ $paciente->usuario->correo }}</p>
                </div>

                <!-- Formulario -->
                <form method="POST" action="{{ route(auth()->user()->isAdmin() ? 'admin.seguimiento.observaciones.store' : 'medico.seguimiento.observaciones.store', $paciente->id_paciente) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="observacion" 
                                  ...
                                  placeholder="Describe la observación médica...">{{ old('observacion') }}</textarea>
                        @error('observacion')
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('fecha_observacion', now()->format('Y-m-d')) }}"
                               required
                    ...
                    <div>
                        ...
                        <select name="tipo" 
                            ...
                            <option value="evolucion" {{ old('tipo') == 'evolucion' ? 'selected' : '' }}>Evolución</option>
                            <option value="alerta" {{ old('tipo') == 'alerta' ? 'selected' : '' }}>Alerta</option>
